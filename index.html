...
<body style="background: rgb(35,35,41);">
    <nav class="navbar navbar-dark navbar-expand-md py-3" style="width: 64%;margin: auto;background: rgb(35,35,41);max-width: 1050px;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="color: rgb(42,42,42);">Terms Of Service</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
<!-------------------------------------------------------------------------------->
    ...
    <div class="card bg-dark" data-aos="fade-up" data-aos-duration="600" data-aos-delay="150" style="width: 88%;margin: auto;margin-top: 5px;border-color: rgb(34,35,42);transform: perspective(0px);">
        <div class="card-body" style="backdrop-filter: brightness(83%);border-radius: 9px;box-shadow: 0px 0px 14px 3px rgba(31,31,31,0.54);">
            <div class="container py-4 py-xl-5" style="border-radius: 6px;">
                ...
                <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                    <div class="col">
                        <div class="card" style="background: rgb(34,35,42);border-color: rgb(34,35,42);box-shadow: 0px 0px 12px 3px rgba(34,35,42,0.8);"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;" src="assets/img/qAVYL5v.gif">
                            <div class="card-body p-4">
                                <h4 class="card-title"><?php echo $h1 ?><br></h4>
                                <p class="card-text"><?php echo $d1 ?></p>
                                <p class="card-text" style="color: rgb(234,104,76);">Price: $10 <strong><?php echo $p1 ?></strong></p><button data-sellix-product="6552efa85ee9e<?php echo $id1 ?>" class="btn btn-primary" type="submit" style="border-radius: 7px;background: rgb(31,32,38);border-color: rgb(31,32,38);width: 100%;color: rgb(221,221,221);"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" style="margin-top: -5px;">
